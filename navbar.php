    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="links">
                ...
                <li><a href="aboutus.php" class="about">About us</a></li>
                 
                <li><a href="mainpage.php#maintainance" class="maintainance" >Maintainance <i class="fa-solid fa-caret-down"></i></a>
                <ul class="submenu">
                    <li><a href="tet.php">Car Services</a></li>
                    <li><a href="car battery.php">Car Battery</a></li>
                    <li><a href="car_engine.php">Engines</a></li>
                    <li><a href="Car_tyre.php">Tyres</a></li>
                    <li><a href="Car_conditioner.php">Air Conds</a></li>
                    <li><a href="Car_audio.php">Audio</a></li>
                    <li><a href="Car_Modification.php">Modification</a></li>
                    <!-- <li><a href="#">Maintainance</a></li> -->
                </ul>
            </li>
            
                <li><a href="mainpage.php#booking" class="booking" >Booking <i class="fa-solid fa-caret-down"></i></a>
                <ul class="submenu">
                ...
                <li><a href="mainpage.php#forum" class="forum">Community <i class="fa-solid fa-caret-down"></i></a>
                <ul class="submenu">
            ...
            <div class='profile-details'>
                <div class='pfp'><a href='profile.php'>
                    <?php 
                        ...
                        if ($row) {
                            echo "<img src='$row[userpic]' alt='profile'>";
                        }
                    ?>
                    </a></div>
                    <div class="name-job">
            ...
            <ul class="link">
                <li class="notification-container">
                    ...
                    <ul class="notifications-list" id="notifications-list">
                        <?php
                        $sql = "SELECT id, subject, DATE_FORMAT(time, '%b %d, %Y %h:%i %p') AS time FROM notifications ORDER BY time DESC";
                        $result = mysqli_query($con, $sql);

                        if (mysqli_num_rows($result) > 0) {
                            while ($notification = mysqli_fetch_assoc($result)) {
                                echo "<li><a href='javascript:void(0);' class='notification-link' data-id='{$notification['id']}'><span class='notification-subject'>{$notification['subject']}</span><span class='notification-time'>{$notification['time']}</span></a></li>";
                            }
                        } else {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function fetchNotifications() {
                fetch("notifications_handler.php?action=count")
            ...
            bellIcon.addEventListener("click", (e) => {
                ...
                if (notificationsList.style.display === "block") {
                    fetch("notifications_handler.php?action=mark_seen")
                        .then(response => response.json())
                        .then(data => {
                            if (data.success) {
