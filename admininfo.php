...
<head>
    ...
    <style>
        ...
        *{
        ...
        /* input[type=text]:focus:valid,input[type=tel]:focus:valid,input[type=email]:focus:valid, input[type=password]:focus:valid{
            ...
            <div class="form">
                <form action="adminupdate.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="profilepic" id="profile-pic-container">
                        ...
                        <img id="profile_pic" src="<?php echo $row['adminpic'] ?>" alt="Profile Picture">
                    </div>
                    <div class="inputbox">
                        <i class="fa-regular fa-envelope"></i>
                        <input type="email" name="adminemail" required value="<?php echo$row['adminemail']?>">
                        <label for="">Email</label>
                    </div>
                    <div class="inputbox">
                        <i class="fa-regular fa-eye" id="display-password" style="cursor: pointer;"></i>
                        <input type="password" name ="admin_password" id="passcode" required value="<?php echo$row['adminpassword']?>">
...
<script>
        ...
        function resetProfilePicture() {
            ...
            var defaultSrc = '<?php echo $row['adminpic'] ?>'; // Default image source
